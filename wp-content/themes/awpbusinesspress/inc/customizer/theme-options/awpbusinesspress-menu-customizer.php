<?php
	...
	// Sticky Bar Logo
	$wp_customize->add_setting( 'awpbusinesspress_sticky_bar_logo', array(
			'sanitize_callback' => 'esc_url_raw',
		)
	);
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'awpbusinesspress_sticky_bar_logo',
     	array(
