...
( function ( $ ) {
	...
	// Service title
	wp.customize(
		'awpbusinesspress_service_area_title', function( value ) {
			value.bind(
				function( newval ) {
	...
	// Service description
	wp.customize(
		'awpbusinesspress_service_area_des', function( value ) {
			value.bind(
				function( newval ) {
	...
	// Testimonial title
	wp.customize(
		'awpbusinesspress_testimonial_area_title', function( value ) {
			value.bind(
				function( newval ) {
	...
	wp.customize(
		'awpbusinesspress_testimonial_area_des', function( value ) {
			value.bind(
				function( newval ) {
	...
	wp.customize(
		'awpbusinesspress_cta_area_title', function( value ) {
			value.bind(
				function( newval ) {
	...
	wp.customize(
		'awpbusinesspress_cta_area_subtitle', function( value ) {
			value.bind(
				function( newval ) {
	...
	wp.customize(
		'awpbusinesspress_cta_area_des', function( value ) {
			value.bind(
				function( newval ) {
	...
	wp.customize(
		'awpbusinesspress_cta_button_text', function( value ) {
			value.bind(
				function( newval ) {
	...
	// Blog title
	wp.customize(
		'awpbusinesspress_blog_area_title', function( value ) {
			value.bind(
				function( newval ) {
	...
	// Blog description
	wp.customize(
		'awpbusinesspress_blog_area_des', function( value ) {
			value.bind(
				function( newval ) {
	...
	wp.customize(
		'awpbusinesspress_footer_copright_text', function( value ) {
			value.bind(
				function( newval ) {
