...
<div <?php comment_class('media comment-box'); ?> id="comment-<?php comment_ID(); ?>">
	...
	<div class="media-body">
		<div class="comment-detail">
			<h6 class="comment-detail-title"><?php comment_author(); ?> <span class="comment-date"><?php esc_html_e('Posted on ','awpbusinesspress'); ?><?php  echo esc_html(comment_time('g:i a')); ?><?php echo " - "; echo esc_html(comment_date('M j, Y'));?></span></h6>
			<?php comment_text(); ?>
